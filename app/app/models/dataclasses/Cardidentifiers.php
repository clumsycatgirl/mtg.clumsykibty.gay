 ...
 *
 * Represents a Cardidentifiers in the system.
 */
class Cardidentifiers {
    private int|null $id;
    ...
    public static function from_imcomplete_class(\__PHP_Incomplete_Class $array): Cardidentifiers {
        $obj = new Cardidentifiers([]);
